...
class QueryLaneHeadV31(nn.Module):
    def __init__(
        self,
        img_w=800,
        img_h=320,
        ...
        super(QueryLaneHeadV31, self).__init__()
    ...
    def pool_prior_features(self, batch_features, prior_xs):
        ...
        feature = feature.reshape(
            ...
            self.fc_hidden_dim*self.feat_sample_points,
        )

        feature = F.relu(self.fc_norm(self.fc(feature)))
        return feature.view(batch_size, self.num_priors, -1)
    ...
    def forward(self, x, **kwargs):
        ...
        for stage, feature in enumerate(prefusion_feature):
            ...
            query_feats = self.attention(
                feature, query_feats+pooled_feature
            )
